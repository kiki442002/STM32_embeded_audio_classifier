...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_AUDIO_CLASSIFIER_MODEL_NAME,
        .config = AI_AUDIO_CLASSIFIER_DATA_CONFIG,
        .ai_get_report = ai_audio_classifier_get_report,
        .ai_create = ai_audio_classifier_create,
        .ai_destroy = ai_audio_classifier_destroy,
        .ai_get_error = ai_audio_classifier_get_error,
        .ai_init = ai_audio_classifier_init,
        .ai_run = ai_audio_classifier_run,
        .ai_forward = ai_audio_classifier_forward,
        .ai_data_params_get = ai_audio_classifier_data_params_get,
