...
#define AI_AUDIO_CLASSIFIER_INPUTS_IN_ACTIVATIONS   (4)
#define AI_AUDIO_CLASSIFIER_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_AUDIO_CLASSIFIER_IN_NUM        (1)

AI_DEPRECATED
#define AI_AUDIO_CLASSIFIER_IN \
  ai_audio_classifier_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_CLASSIFIER_IN_SIZE { \
  AI_AUDIO_CLASSIFIER_IN_1_SIZE, \
}
...
/******************************************************************************/
#define AI_AUDIO_CLASSIFIER_OUT_NUM       (1)

AI_DEPRECATED
#define AI_AUDIO_CLASSIFIER_OUT \
  ai_audio_classifier_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_AUDIO_CLASSIFIER_OUT_SIZE { \
  AI_AUDIO_CLASSIFIER_OUT_1_SIZE, \
}
...
/******************************************************************************/
#define AI_AUDIO_CLASSIFIER_N_NODES (15)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup audio_classifier
 ...
 * @ref ai_audio_classifier_create. Both the activations memory buffer 
 ...
 * using @ref ai_audio_classifier_get_error
 */
AI_API_ENTRY
 ...
 * header generated by the code generation tool. See AI_AUDIO_CLASSIFIER_*
 * defines into file @ref audio_classifier.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_audio_classifier_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_AUDIO_CLASSIFIER_H */
