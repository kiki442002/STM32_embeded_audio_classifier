...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "small_cnn_model"
...
#define AI_NETWORK_IN_1_WIDTH       (30)
#define AI_NETWORK_IN_1_SIZE        (32 * 1 * 30)
#define AI_NETWORK_IN_1_SIZE_BYTES  (3840)
